		...
		Steps: []resource.TestStep{
			{ // an ISO, the default format
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					testAccCheckMediaURL("data.omni_installation_media.test", ".iso"),
				),
			},
			{ // an explicit format reaches the factory as a disk image
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					testAccCheckMediaURL("data.omni_installation_media.test", ".raw.xz"),
				),
			},
			{ // PXE yields a script URL with no file extension
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					testAccCheckMediaURL("data.omni_installation_media.test", ""),
				),
			},
		},
	})
...
func testAccCheckMediaURL(resourceName, suffix string) resource.TestCheckFunc {
